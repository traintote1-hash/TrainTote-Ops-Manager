...
<?php if(!$stops):?><div class="alert alert-info">No route stops are configured. Selected Route / Territory generation will remain unavailable until at least one stop is added, or the Job Title scope is changed to Entire Railroad.</div><?php endif;?>
