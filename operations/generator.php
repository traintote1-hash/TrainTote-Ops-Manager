...
{
    $selectedRoute = ($assignment['work_scope'] ?? 'entire_railroad') === 'selected_route' && count($routeStops) > 0;
    if ($selectedRoute) {
        return ttChooseRouteExchangeMoves($assignment, $cars, $industries, $startingIds, $reservedIds, $routeStops);
    }
